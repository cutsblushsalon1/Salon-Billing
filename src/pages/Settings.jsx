            ...
            <div className="rounded-lg bg-plum/5 p-3 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  />
                  <p className="text-[11px] text-muted mt-1.5">Must match the name of the approved template exactly (case-sensitive).</p>
                </div>
                <div>
...
Book your next appointment through our website and get *flat 25% off on all services*!`}
                ...
                <p className="text-[11px] text-muted mt-2">
                  {'{{1}}'} name, {'{{2}}'} number of days since last visit, {'{{3}}'} name of last service — all
                  generated automatically per client, never typed in. The 25% offer is fixed copy in the approved
                  template itself, not a variable.
                </p>
              </div>
